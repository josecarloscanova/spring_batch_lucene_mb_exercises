...
public class ReleaseGroupBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"/spring-batch-file-jobs/database/release_group_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("releaseGroupDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("releaseGroupDatabaseJob", "");
