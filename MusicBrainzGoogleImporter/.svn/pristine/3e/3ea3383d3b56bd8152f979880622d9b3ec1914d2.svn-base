...
public class MediumCdTocBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/medium_cdtoc_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("mediumCdTocDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("mediumCdTocDatabaseJob", "");
