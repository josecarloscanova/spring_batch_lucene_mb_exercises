...
public class IsrcBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/isrc_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("isrcDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("isrcDatabaseJob", "");
