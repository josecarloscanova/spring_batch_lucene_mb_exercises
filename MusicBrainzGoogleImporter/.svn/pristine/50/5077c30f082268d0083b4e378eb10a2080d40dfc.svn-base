...
public class ArtistAliasBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/artist_alias_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("artistAliasDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("artistAliasDatabaseJob", "");
