...
public class TrackBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/track_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("trackDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("trackDatabaseJob", "");
