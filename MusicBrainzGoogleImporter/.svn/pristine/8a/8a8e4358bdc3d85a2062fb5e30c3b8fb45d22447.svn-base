...
public class TrackListBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/tracklist_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("trackListDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("trackListDatabaseJob", "");
