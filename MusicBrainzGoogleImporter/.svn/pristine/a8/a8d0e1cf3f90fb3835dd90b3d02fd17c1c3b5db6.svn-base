...
public class WorkAliasBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/work_alias_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("workAliasDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("workAliasDatabaseJob", "");
