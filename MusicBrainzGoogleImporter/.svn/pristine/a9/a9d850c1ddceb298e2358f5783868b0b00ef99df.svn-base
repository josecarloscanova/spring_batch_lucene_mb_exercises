...
public class WorkNameBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/work_name_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("workNameDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("workNameDatabaseJob", "");
