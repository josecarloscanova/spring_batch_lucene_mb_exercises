...
public class CdTocBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/cdtoc_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("cdTocDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("cdTocDatabaseJob", "");
