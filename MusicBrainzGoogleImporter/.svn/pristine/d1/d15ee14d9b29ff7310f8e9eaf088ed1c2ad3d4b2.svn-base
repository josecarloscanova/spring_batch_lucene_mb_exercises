...
public class ReleaseNameBootLoader {
	...
	public static void main(String[] args)  {
		...
		"/spring-batch-file-jobs/database/release_name_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("releaseNameIndexJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("releaseNameIndexJob", "");
