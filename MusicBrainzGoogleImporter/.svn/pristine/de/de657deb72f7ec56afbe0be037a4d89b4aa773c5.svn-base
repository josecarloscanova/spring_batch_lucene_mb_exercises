...
public class RecordingBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"/spring-batch-file-jobs/database/recording_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("recordingDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("recordingDatabaseJob", "");
