...
public class ArtistNameBootLoader {
	...
	public static void main(String[] args)  {
		...
		"/spring-batch-file-jobs/artist_name_index_writer_job.xml"};
...
//		Job artis = (Job) ctx.getBean("artistNameIndexJob");
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("artistNameIndexJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("artistNameIndexJob", "");
