...
public class ArtistCreditBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/artist_credit_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("artistCreditDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("artistCreditDatabaseJob", "");
