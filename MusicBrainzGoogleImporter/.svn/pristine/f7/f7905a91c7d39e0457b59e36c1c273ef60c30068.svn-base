...
public class LabelBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/label_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("labelDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("labelDatabaseJob", "");
