...
public class ArtistCreditNameBootLoader {
	...
	public static void main(String[] args)  {
		...
		Job artistKeyJob = (Job) ctx.getBean("artistCreditNameJob");
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("artistCreditNameJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("artistCreditNameJob", "");
