...
public class ArtistKeyBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/artist_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("artistKeyDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("artistKeyDatabaseJob", "");
