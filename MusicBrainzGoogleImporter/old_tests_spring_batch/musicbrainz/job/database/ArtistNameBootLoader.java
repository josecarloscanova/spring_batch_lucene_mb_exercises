...
public class ArtistNameBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/artist_name_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("artistNameDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("artistNameDatabaseJob", "");
