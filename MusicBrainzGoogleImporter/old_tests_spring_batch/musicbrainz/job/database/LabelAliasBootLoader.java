...
public class LabelAliasBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/label_alias_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("labelAliasDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("labelAliasDatabaseJob", "");
