...
public class LabelNameBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/label_name_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("labelNameDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("labelNameDatabaseJob", "");
