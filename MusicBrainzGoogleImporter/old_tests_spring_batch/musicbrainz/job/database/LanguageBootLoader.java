...
public class LanguageBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/language_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("languageDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("languageDatabaseJob", "");
