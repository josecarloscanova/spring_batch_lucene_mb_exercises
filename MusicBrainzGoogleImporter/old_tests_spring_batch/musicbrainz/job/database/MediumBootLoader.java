...
public class MediumBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/medium_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("mediumDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("mediumDatabaseJob", "");
