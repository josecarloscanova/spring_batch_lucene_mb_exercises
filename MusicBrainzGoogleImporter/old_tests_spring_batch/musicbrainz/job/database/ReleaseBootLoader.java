...
public class ReleaseBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"/spring-batch-file-jobs/database/release_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("releaseDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("releaseDatabaseJob", "");
