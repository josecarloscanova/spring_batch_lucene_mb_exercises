...
public class ReleaseLabelBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"/spring-batch-file-jobs/database/release_label_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("releaseLabelDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("releaseLabelDatabaseJob", "");
