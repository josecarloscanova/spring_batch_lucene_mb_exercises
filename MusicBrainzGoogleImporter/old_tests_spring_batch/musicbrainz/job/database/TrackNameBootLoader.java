...
public class TrackNameBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/track_name_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("trackNameDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("trackNameDatabaseJob", "");
