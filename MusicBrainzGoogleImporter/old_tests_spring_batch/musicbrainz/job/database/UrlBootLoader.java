...
public class UrlBootLoader {
	...
	public static void main(String[] args)  {
		String [] baseContext = new String[] {
				...
				"spring-batch-file-jobs/database/url_database_writer_job.xml"};
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("urlDatabaseJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("urlDatabaseJob", "");
