...
public class TrackNameBootLoader {
	...
	public static void main(String[] args)  {
		...
		"/spring-batch-file-jobs/track_name_index_writer_job.xml"};
...
//		Job artis = (Job) ctx.getBean("artistNameIndexJob");
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("trackNameIndexJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("trackNameIndexJob", "");
