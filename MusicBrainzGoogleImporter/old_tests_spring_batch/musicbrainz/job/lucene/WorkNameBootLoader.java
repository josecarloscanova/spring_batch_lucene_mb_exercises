...
public class WorkNameBootLoader {
	...
	public static void main(String[] args)  {
		...
		"/spring-batch-file-jobs/work_name_index_writer_job.xml"};
...
//		Job artis = (Job) ctx.getBean("artistNameIndexJob");
		...
		try { 
			...
			Set<Long> executions = jobOperator.getRunningExecutions("workNameIndexJob");
...
//				jobOperator.stop(it.next());  
			...
			jobOperator.start("workNameIndexJob", "");
